...
<body>
    ...
    <div class="form-container">
        ...
        <form method="POST" action="{{ route('updateRequest', $productRequest->id) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row mb-4">
                <div class="col-md-6">
                    <div class="form-floating mb-3">
                        <input type="text" id="name" class="form-control text-right" value="{{ $productRequest->name }}" name="name" placeholder="اسم المنتج"/>
                        <label for="name" class="text-right">اسم المنتج</label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-floating mb-3">
                        <input type="text" id="price" class="form-control text-right" value="{{ $productRequest->price }}" name="price" placeholder="السعر"/>
            ...
            <div class="form-floating mb-4">
                <input type="text" id="percentage" class="form-control text-right" value="{{ $productRequest->percentage }}" name="percentage" placeholder="النسبة"/>
