...
<body>
    ...
    <div class="up">
        ...
        <div class="title">
            ...
            <a href="{{ route('requestProduct') }}">إقتراح منتج</a>
            <div class="icon">
        ...
        <th>حذف المنتج</th>
            ...
            @foreach ($requests as $request)
                <tr>
                    ...
                    <td data-cell="حذف المنتج"><form method="POST" action="{{route('deleteRequest',$request)}}" >
                        @csrf
                        @method('delete')
                        <button type="submit" class="delete">حذف المنتج</button>
                    </form></td>
                </tr>
            @endforeach
    </table>
