...
<body>
    ...
    <div class="form-container">
        <h3 class="mb-4">إقتراح منتج</h3>
        <form method="POST" action="{{ route('storeRequestedProduct') }}" enctype="multipart/form-data">
            @csrf
            <!-- Product Name -->
            <div class="row mb-4">
                <div class="col-md-6">
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" class="btn btn-primary mb-4">إقتراح</button>
            </div>
        </form>
    </div>
